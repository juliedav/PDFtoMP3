...
__all__ = [
    'ISpeechObjectToken', 'DISPID_SRCEEndStream', 'eWORDTYPE_ADDED',
    'SAFT16kHz16BitMono', 'SPPROPERTYINFO', 'SGLexical',
    'ISpeechVoice', 'ISpeechGrammarRuleStateTransition',
    'SPFM_OPEN_READWRITE', 'SVSFUnusedFlags', 'SRAONone',
    'DISPID_SpeechLexiconPronunciation', 'SINone',
    'DISPID_SRRTLength', 'DISPID_SpeechCustomStream',
    'DISPID_SRGRules', 'ISpShortcut', 'SpeechTokenKeyAttributes',
    'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SpeechRecognizerStatus', 'SPFM_NUM_MODES', 'SVEBookmark',
    'SVSFIsXML', 'SPEI_RESERVED2', 'DISPID_SVSkip',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'eLEXTYPE_RESERVED10',
    'DISPID_SVAlertBoundary', 'DISPID_SPRText',
    'DISPID_SOTRemoveStorageFileName', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SPPs_NewEnum',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SGRsCommitAndSave', 'DISPID_SOTGetAttribute',
    'DISPID_SPIReplacements', 'SPPS_Noncontent', 'SASPause',
    'SPEI_TTS_AUDIO_LEVEL', 'SAFT11kHz8BitStereo',
    'SPDKL_DefaultLocation', 'SAFTADPCM_8kHzStereo',
    'DISPID_SPPFirstElement', 'Speech_Max_Pron_Length',
    'DISPID_SRCreateRecoContext', 'SpeechVoiceEvents',
    'SREFalseRecognition', 'SAFT12kHz16BitStereo',
    'DISPID_SVEPhoneme', 'SPPS_RESERVED3', 'DISPID_SDKEnumKeys',
    'DISPID_SPIEnginePrivateData', 'SPINTERFERENCE_NONE',
    'DISPID_SVGetAudioInputs', 'DISPID_SAFSetWaveFormatEx',
    'SVEWordBoundary', 'SAFT24kHz8BitStereo', 'SPBO_TIME_UNITS',
    'DISPID_SDKCreateKey', 'ISpXMLRecoResult',
    'DISPID_SGRSTNextState', 'SP_VISEME_19', 'SAFTText',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SpeechAudioFormatGUIDText', 'LONG_PTR', 'DISPID_SPRFirstElement',
    'SRAORetainAudio', 'DISPID_SGRsItem', 'DISPID_SPPsCount',
    'SRAInterpreter', 'DISPID_SPEAudioStreamOffset', 'SPPS_RESERVED1',
    'ISpeechPhraseReplacement', 'SPPHRASEELEMENT',
    'ISpeechPhraseElements', 'SDKLDefaultLocation',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SPEDisplayAttributes', 'DISPID_SASState',
    'DISPID_SpeechObjectTokens', 'SPEI_MIN_SR', 'SPSVerb',
    'IEnumString', 'SPPS_LMA', 'SpStream', 'SPPS_Function',
    'SP_VISEME_1', 'DISPID_SpeechLexiconWord', 'SpeechTokenKeyFiles',
    'SAFTCCITT_uLaw_44kHzMono', 'SVSFPurgeBeforeSpeak',
    'ISequentialStream', 'SPAR_Unknown', 'SREAdaptation',
    'SPFM_OPEN_READONLY', 'DISPID_SPRuleChildren', 'SP_VISEME_0',
    'SPEI_FALSE_RECOGNITION', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SRRGetXMLErrorInfo', 'SPWORDPRONOUNCEABLE',
    'DISPID_SRCEStartStream', 'ISpeechPhraseReplacements',
    'SP_VISEME_20', 'DISPID_SPCLangId', 'DISPID_SGRSTPropertyId',
    'eLEXTYPE_PRIVATE10', 'eLEXTYPE_PRIVATE8', 'SAFT11kHz8BitMono',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SOTCategory',
    'DISPID_SRRSaveToMemory', 'SpeechCategoryRecognizers',
    'SAFT48kHz8BitStereo', 'DISPID_SASFreeBufferSpace',
    'SAFT22kHz16BitMono', 'SP_VISEME_13', 'DISPID_SVResume',
    'SPPHRASE', 'SPSHORTCUTTYPE', 'SPCONTEXTSTATE',
    'tagSPTEXTSELECTIONINFO', 'SLOStatic',
    'DISPID_SGRSAddWordTransition', 'SAFTCCITT_uLaw_11kHzMono',
    'SREStreamEnd', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SpeechPhraseElement', 'DISPID_SLWsItem',
    'DISPID_SPAsItem', 'DISPID_SLPLangId', 'SGDisplay',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SLPPhoneIds',
    'DISPID_SPEEngineConfidence', 'SVP_12',
    'DISPID_SRCEventInterests', 'SpeechVisemeFeature',
    'DISPID_SGRSAddSpecialTransition', 'ISpeechGrammarRuleState',
    'SPVPRIORITY', 'ISpeechDataKey', 'DISPID_SRRSpeakAudio',
    'DISPID_SRGetPropertyString', 'SGSDisabled', 'SRERecognition',
    'SpeechAddRemoveWord', 'DISPID_SGRSTs_NewEnum',
    'eLEXTYPE_RESERVED7', 'DISPID_SPACommit',
    'DISPID_SVSInputSentenceLength',
    'SpeechPropertyComplexResponseSpeed',
    'SpeechPropertyLowConfidenceThreshold', 'SGRSTTTextBuffer',
    'SpeechCategoryAudioIn', 'SPSModifier', 'SPSHT_NotOverriden',
    'SPFILEMODE', 'SPRECORESULTTIMES', 'SGSEnabled',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SVGetAudioOutputs',
    'DISPID_SGRAddResource', 'SPINTERFERENCE_TOOLOUD', 'SVEViseme',
    'DISPID_SpeechPhoneConverter', 'SPEI_VOICE_CHANGE',
    'ISpObjectToken', 'SPDATAKEYLOCATION', 'SPLOADOPTIONS',
    'DISPID_SVEViseme', 'ISpeechPhraseAlternate',
    'SPEI_SR_AUDIO_LEVEL', 'SpeechRuleAttributes', 'DISPID_SRRTimes',
    'SpeechRetainedAudioOptions', 'SpMMAudioIn', 'SPPARTOFSPEECH',
    'SPRST_ACTIVE', 'DISPID_SRGCmdSetRuleIdState', 'SVSFParseSsml',
    'DISPID_SADefaultFormat', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SMSGetData', 'SVF_Emphasis', 'SVP_13', 'SFTSREngine',
    'SDTReplacement', 'STSF_AppData', 'DISPID_SRState',
    'eWORDTYPE_DELETED', 'DISPID_SPISaveToMemory', 'DISPID_SBSFormat',
    'DISPID_SPRs_NewEnum', 'SPADAPTATIONRELEVANCE',
    'DISPID_SRIsUISupported', 'SpeechFormatType', 'DISPID_SLPsCount',
    'SPLEXICONTYPE', 'DISPID_SBSSeek',
    'SpeechGrammarRuleStateTransitionType',
    'SpPhoneticAlphabetConverter', 'DISPID_SPCIdToPhone',
    'SAFT12kHz16BitMono', 'DISPID_SRGIsPronounceable',
    'DISPID_SOTCId', 'SGDSActiveUserDelimited', 'ISpeechAudioFormat',
    'SPRECOCONTEXTSTATUS', 'ISpSerializeState', 'ISpRecoContext2',
    'SpeechRegistryUserRoot', 'DISPID_SVEStreamStart',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SRRTStreamTime',
    'SPWORDTYPE', 'DISPID_SPEsCount', 'DISPID_SGRsFindRule',
    'SpeechCategoryPhoneConverters', 'DISPID_SDKSetLongValue',
    'SGDSActiveWithAutoPause', 'SpeechWordType', 'SPEI_MAX_TTS',
    'SREStateChange', 'DISPID_SPIAudioSizeTime', 'eLEXTYPE_RESERVED4',
    'SSSPTRelativeToCurrentPosition', 'eLEXTYPE_PRIVATE11',
    'SPCS_ENABLED', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SpeechWaveFormatEx', 'SASStop', 'SAFTGSM610_11kHzMono',
    'SECFNoSpecialChars', 'DISPID_SPRules_NewEnum', 'DISPID_SLPsItem',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SRRRecoContext',
    'SpeechCategoryRecoProfiles', 'DISPID_SRCESoundEnd',
    'DISPID_SGRSTransitions', 'SPGS_EXCLUSIVE', 'SRTReSent',
    'ISpeechWaveFormatEx', 'ISpNotifySink', 'SpeechAudioProperties',
    'STCLocalServer', 'SDTAll', 'SP_VISEME_4', 'SVSFParseMask',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SpeechRecognizer',
    'DISPID_SDKDeleteValue', 'ISpeechRecoGrammar',
    'DISPID_SPRuleEngineConfidence', 'SRERecoOtherContext', 'SVP_20',
    'SPBO_NONE', 'ISpeechPhraseProperty', 'SpInProcRecoContext',
    'eLEXTYPE_PRIVATE12', 'SpeechLexiconType', 'SAFT44kHz8BitMono',
    'SREAudioLevel', 'DISPID_SRAudioInput', 'eLEXTYPE_PRIVATE9',
    'STCInprocHandler', 'DISPID_SpeechDataKey', 'SDTDisplayText',
    'DISPID_SGRSTRule', 'DISPID_SRCRetainedAudioFormat',
    'SpCustomStream', 'WAVEFORMATEX', 'SpeechCategoryAudioOut',
    'SGDSActive', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SVEventInterests',
    'SPPS_Interjection', 'DISPID_SDKOpenKey', 'eLEXTYPE_PRIVATE20',
    'SPWT_LEXICAL', 'SLODynamic', 'SSTTDictation',
    'SPRECOGNIZERSTATUS', 'SDA_No_Trailing_Space', 'SREPhraseStart',
    'DISPID_SOTs_NewEnum', 'DISPID_SpeechLexiconWords',
    'SPWT_PRONUNCIATION', 'DISPID_SLGetWords', 'SVP_2',
    'SDA_Two_Trailing_Spaces', 'SPSTREAMFORMATTYPE',
    'ISpeechRecognizerStatus', 'SPVPRI_OVER', 'eLEXTYPE_PRIVATE19',
    'ISpeechMMSysAudio', 'SRAImport', 'ISpRecognizer',
    'DISPID_SOTCSetId', 'ISpeechPhoneConverter', 'SP_VISEME_9',
    'SPEI_START_INPUT_STREAM', '__MIDL_IWinTypes_0009',
    'SpeechRecoContextState', 'DISPID_SASetState',
    'SAFT24kHz16BitMono', 'SPVISEMES', 'DISPID_SCSBaseStream',
    'ISpNotifySource', 'DISPID_SPRulesCount', 'DISPID_SFSClose',
    'SPEVENTSOURCEINFO', 'SVSFPersistXML', 'SpLexicon',
    'SpeechTokenKeyUI', 'DISPID_SOTMatchesAttributes',
    'ISpProperties', 'DISPID_SRGCmdLoadFromFile', 'ISpStream',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SRGSetWordSequenceData',
    'SPBINARYGRAMMAR', 'SPAUDIOSTATUS', 'SBONone',
    '_ISpeechVoiceEvents', 'SPSLMA', 'DISPID_SVPriority',
    'SPEI_SR_BOOKMARK', 'DISPID_SGRsDynamic', 'DISPID_SABIEventBias',
    'STSF_LocalAppData', 'DISPID_SGRsCommit', 'SAFT8kHz16BitStereo',
    'DISPID_SWFEExtraData', 'DISPID_SLWWord', 'SPSHT_OTHER',
    'SREBookmark', 'DISPID_SOTsItem', 'SPAS_CLOSED',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SPIElements',
    'SRTAutopause', 'DISPID_SRRPhraseInfo', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SGRsCount', 'SECHighConfidence', 'eLEXTYPE_APP',
    'SECNormalConfidence', 'SpeechDataKeyLocation',
    'SSSPTRelativeToEnd', 'SECFDefault', 'SVP_6', 'SP_VISEME_15',
    'SDTRule', 'ISpMMSysAudio', 'SPEI_SOUND_START', 'SVP_21',
    'SAFT8kHz8BitStereo', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SRSSupportedLanguages', 'DISPID_SMSALineId',
    'DISPID_SRCVoice', 'DISPID_SPAs_NewEnum', 'SpObjectTokenCategory',
    'SAFT48kHz16BitMono', 'ISpRecoCategory',
    'SREPropertyStringChange', 'ISpGrammarBuilder',
    '_RemotableHandle', 'Speech_Max_Word_Length',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SpeechTokenIdUserLexicon',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SDTLexicalForm',
    'DISPID_SPRuleParent', 'DISPID_SRGRecoContext',
    'SpSharedRecognizer', 'SPEI_RECOGNITION', 'ISpResourceManager',
    'DISPID_SRRAudio', 'SPSHT_Unknown', 'DISPID_SpeechVoiceStatus',
    'SVP_11', 'SpeechAudioFormatGUIDWave', 'SpeechDisplayAttributes',
    'SVF_Stressed', 'SRSEDone', 'DISPID_SPILanguageId',
    'DISPID_SLGetGenerationChange', 'SREPropertyNumChange',
    'DISPID_SGRAddState', 'SPBO_PAUSE', 'SPAR_Medium',
    'DISPID_SRCEAdaptation', 'SpeechBookmarkOptions',
    'tagSPPROPERTYINFO', 'UINT_PTR', 'DISPID_SPEAudioSizeTime',
    'ISpVoice', 'ISpeechPhraseRules', 'SpeechPropertyResponseSpeed',
    'SAFTNoAssignedFormat', 'SAFT32kHz8BitMono',
    'DISPID_SpeechGrammarRuleStateTransition', 'SPWF_INPUT',
    'DISPID_SpeechFileStream', 'SpNullPhoneConverter', 'SVP_19',
    'SpeechRecognizerState', 'SAFTTrueSpeech_8kHz1BitMono',
    'SP_VISEME_17', 'ISpPhrase', 'SpeechCategoryAppLexicons',
    'SDA_One_Trailing_Space', 'SpeechVoicePriority',
    'SAFTADPCM_11kHzStereo', 'DISPID_SPAsCount',
    'DISPID_SPIGrammarId', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SLWLangId', 'ISpObjectTokenCategory', 'DISPID_SAFGuid',
    'DISPIDSPRG', 'SAFT32kHz16BitMono',
    'DISPID_SVSInputSentencePosition', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SPIEngineId', 'eLEXTYPE_RESERVED6',
    'DISPID_SPARecoResult', 'SVSFDefault', 'SpInprocRecognizer',
    'DISPID_SVDisplayUI', 'SVPOver', 'DISPID_SABIBufferSize',
    'SPTEXTSELECTIONINFO', 'SPGS_ENABLED', 'ISpeechPhraseAlternates',
    'SPEI_TTS_BOOKMARK', 'DISPID_SPPNumberOfElements',
    'ISpRecoGrammar', 'DISPID_SRGCommit', 'SPPS_Unknown',
    'ISpeechRecoContext', 'DISPID_SLPSymbolic', 'SFTInput',
    'SpeechEngineConfidence', 'DISPID_SPRulesItem', 'DISPID_SVSpeak',
    'SpFileStream', 'SpeechRunState', 'SPFM_CREATE_ALWAYS',
    'SPPS_Modifier', 'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SRCEBookmark', 'SpeechEngineProperties', 'SVSFVoiceMask',
    'SPGRAMMARSTATE', 'DISPID_SOTGetStorageFileName',
    'ISpeechPhraseProperties', 'DISPID_SASNonBlockingIO',
    'SPWAVEFORMATTYPE', 'SPEI_RECO_STATE_CHANGE',
    'SAFTADPCM_11kHzMono', 'DISPID_SpeechMemoryStream',
    'SpUnCompressedLexicon', 'SVEStartInputStream', 'SREPrivate',
    'SRSActive', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SGRAttributes',
    'SDTAlternates', 'DISPID_SVSInputWordLength',
    'DISPID_SRCVoicePurgeEvent', 'ISpeechLexiconWords',
    'SAFT8kHz16BitMono', 'DISPID_SpeechGrammarRules',
    'DISPID_SABufferNotifySize', 'SPEVENTENUM', 'SGRSTTRule',
    'SWPUnknownWordPronounceable', 'SVP_5',
    'DISPID_SRGDictationSetState', 'SpObjectToken', 'DISPID_SVPause',
    'DISPID_SpeechRecoResult2', 'SRADynamic', 'ISpeechRecoResult2',
    'SP_VISEME_16', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SRCResume', 'DISPID_SDKDeleteKey', 'SPEI_MAX_SR',
    'SDKLCurrentUser', 'DISPID_SVSCurrentStreamNumber',
    'SPEI_PROPERTY_NUM_CHANGE', 'ISpeechLexiconPronunciations',
    'SpeechEmulationCompareFlags', 'SSFMOpenForRead',
    'SAFT32kHz16BitStereo', 'SPPS_Noun', 'SPWORD',
    'DISPID_SLGenerationId', 'SVP_7', 'SVEEndInputStream',
    'SpeechGrammarState', 'SRTSMLTimeout', 'SAFTDefault',
    'DISPID_SOTRemove', 'DISPID_SVSLastResult', 'eLEXTYPE_PRIVATE7',
    'SAFT48kHz8BitMono', 'DISPID_SWFESamplesPerSec', 'SPSFunction',
    'DISPID_SFSOpen', 'SpeechRuleState', 'SREAllEvents',
    'DISPID_SPPChildren', 'DISPID_SpeechPhraseRule', 'SpShortcut',
    'ISpPhoneticAlphabetConverter', 'DISPID_SLWsCount',
    'SPXRO_Alternates_SML', 'SPAS_RUN', 'SDA_Consume_Leading_Spaces',
    'SpeechSpecialTransitionType', 'DISPID_SpeechPhraseReplacement',
    'SVESentenceBoundary', 'DISPID_SPPId', 'DISPID_SDKSetBinaryValue',
    'STSF_CommonAppData', 'DISPID_SRDisplayUI', 'SP_VISEME_14',
    'DISPID_SRGState', 'DISPID_SRCEPhraseStart',
    'DISPID_SRCEEnginePrivate', 'DISPID_SLAddPronunciationByPhoneIds',
    'SAFT22kHz16BitStereo', 'SAFTGSM610_8kHzMono', 'SPAS_STOP',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SpeechAudioStatus',
    'SECFEmulateResult', 'DISPID_SpeechRecoResult',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SPEI_START_SR_STREAM',
    'SpWaveFormatEx', 'SVP_17', 'SPRULESTATE',
    'DISPID_SVSpeakCompleteEvent', 'ISpeechFileStream',
    'DISPID_SPRsCount', 'DISPID_SRCEInterference', 'ISpRecognizer2',
    'SVP_3', 'DISPID_SpeechAudioFormat', 'SPVOICESTATUS',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SOTCDefault',
    'SRTStandard', 'SpeechGrammarWordType', 'SP_VISEME_3',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SVEStreamEnd',
    'DISPID_SRGDictationLoad', 'DISPID_SMSSetData',
    'SPEI_RECO_OTHER_CONTEXT', 'SpeechVoiceSpeakFlags', 'SVP_8',
    'SAFTCCITT_ALaw_44kHzMono', 'SP_VISEME_10', 'SPEI_RESERVED6',
    'SPRST_INACTIVE_WITH_PURGE', 'STCAll', 'SAFTADPCM_44kHzMono',
    'DISPID_SRGetFormat', 'DISPID_SRGDictationUnload',
    'SPCT_SUB_COMMAND', 'DISPID_SOTIsUISupported', 'DISPID_SPPName',
    'DISPID_SVStatus', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SVEAudioLevel', 'DISPID_SRCState', 'SAFT44kHz16BitStereo',
    'DISPID_SRCRequestedUIType', 'SPINTERFERENCE_NOSIGNAL',
    'eLEXTYPE_PRIVATE4', 'DISPID_SRRGetXMLResult',
    'ISpeechTextSelectionInformation',
    'DISPID_SRCCreateResultFromMemory', 'SRSInactiveWithPurge',
    'DISPID_SPEActualConfidence', 'SpResourceManager',
    'SPEI_REQUEST_UI', 'DISPID_SPRuleFirstElement',
    'DISPID_SGRSTType', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SPCT_COMMAND', 'SPWORDLIST', 'SAFTADPCM_22kHzMono', 'ISpLexicon',
    'DISPID_SRGId', 'SPRULE', 'SAFT44kHz16BitMono', 'SPRS_INACTIVE',
    'DISPID_SRCEHypothesis', 'DISPID_SGRSRule',
    'SAFTGSM610_44kHzMono', 'SGDSInactive', 'SPINTERFERENCE_NOISE',
    'SpeechAllElements', 'ISpAudio', 'eLEXTYPE_PRIVATE14',
    'SAFT12kHz8BitStereo', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SRSClsidEngine', 'ISpeechRecoResult', 'SWTAdded',
    'SRSActiveAlways', 'SPEI_PHRASE_START', 'ISpeechLexicon',
    'ISpeechRecoResultTimes', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SVP_15', 'DISPID_SOTDisplayUI', 'DISPID_SPPValue',
    'ISpEventSink', 'DISPID_SOTSetId', 'SGRSTTEpsilon',
    'ISpeechRecognizer', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SWFEFormatTag', 'DISPID_SWFEChannels', 'DISPID_SVRate',
    'DISPID_SLPPartOfSpeech', 'SRATopLevel', 'DISPID_SLPType',
    'DISPID_SOTsCount', 'SpStreamFormatConverter',
    'DISPID_SPANumberOfElementsInResult', 'SPEVENT', 'SVP_14',
    'DISPID_SRProfile', 'eLEXTYPE_PRIVATE3',
    'DISPID_SpeechPhraseInfo', 'SPRS_ACTIVE_USER_DELIMITED', 'SVP_18',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SPERequiredConfidence',
    'DISPID_SOTCGetDataKey', 'DISPID_SVEBookmark',
    'SPSERIALIZEDRESULT', 'SDTProperty', 'DISPID_SpeechRecoContext',
    'DISPID_SVEVoiceChange', 'SPSERIALIZEDPHRASE',
    'SPCT_SUB_DICTATION', 'Speech_StreamPos_RealTime',
    'ISpeechPhraseRule', 'DISPID_SPEs_NewEnum', 'DISPID_SMSADeviceId',
    'DISPID_SRRecognizer', 'DISPID_SVAudioOutput',
    'SPEI_END_SR_STREAM', 'SPFM_CREATE', 'eLEXTYPE_PRIVATE6',
    'DISPID_SpeechVoiceEvent', 'SAFT44kHz8BitStereo',
    'DISPID_SPRuleConfidence', 'SVP_1', 'SBOPause',
    'SAFT16kHz8BitStereo', 'SAFTCCITT_uLaw_8kHzStereo',
    'SECFIgnoreCase', 'DISPID_SPEPronunciation', 'SPGRAMMARWORDTYPE',
    'SPPHRASERULE', 'DISPID_SPIGetDisplayAttributes', 'SP_VISEME_21',
    'ISpPhoneConverter', 'SPCT_SLEEP', 'SP_VISEME_12', 'SRARoot',
    'SVP_9', 'SDTAudio', 'DISPID_SRRTOffsetFromStart',
    'ISpeechBaseStream', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SpeechPropertyResourceUsage', 'SPPHRASEPROPERTY',
    'DISPID_SpeechPhraseRules', 'SpVoice', 'SAFT8kHz8BitMono',
    'SpeechLoadOption', 'SpeechMicTraining', 'SPAO_RETAIN_AUDIO',
    'SpeechRecoProfileProperties', 'DISPID_SRCPause', 'SPRS_ACTIVE',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SRRSetTextFeedback',
    'eLEXTYPE_USER', 'SP_VISEME_6', 'SPDKL_CurrentConfig',
    'DISPID_SVSPhonemeId', 'eLEXTYPE_VENDORLEXICON',
    'ISpeechObjectTokenCategory', 'SDTPronunciation',
    'DISPID_SAFType', 'SPXMLRESULTOPTIONS', 'ISpeechGrammarRule',
    'ISpeechAudioStatus', 'SAFT48kHz16BitStereo',
    'DISPID_SDKGetBinaryValue', 'DISPID_SPRNumberOfElements',
    'DISPID_SGRName', 'DISPID_SVWaitUntilDone', 'SAFT24kHz8BitMono',
    'DISPID_SLWPronunciations', 'SECFIgnoreWidth',
    'DISPID_SpeechObjectTokenCategory', 'IInternetSecurityManager',
    'DISPID_SRCERequestUI', 'SAFTExtendedAudioFormat', 'SGRSTTWord',
    'SRTEmulated', 'SRSEIsSpeaking',
    'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SRCCreateGrammar',
    'SPEI_INTERFERENCE', 'SpeechUserTraining',
    'DISPID_SVSLastStreamNumberQueued', 'SASClosed',
    'SRADefaultToActive', 'SSFMCreate', 'SPEI_MIN_TTS',
    'DISPID_SRSCurrentStreamPosition', 'SRESoundStart',
    'SGLexicalNoSpecialChars', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SPCPhoneToId', 'DISPID_SREmulateRecognition',
    'SAFT22kHz8BitStereo', 'SECLowConfidence', 'SPBO_AHEAD',
    'DISPID_SRCSetAdaptationData', 'SVP_0', 'DISPID_SDKEnumValues',
    'DISPID_SAVolume', 'DISPID_SVSpeakStream', 'SGPronounciation',
    'DISPID_SRSetPropertyNumber', '_ISpeechRecoContextEvents',
    'eLEXTYPE_PRIVATE13', 'DISPIDSPTSI_ActiveOffset',
    'SPSInterjection', 'SPEI_RESERVED5', 'SPCATEGORYTYPE',
    'SpeechVisemeType', 'DISPID_SASCurrentDevicePosition',
    'SAFT16kHz8BitMono', 'DISPID_SABufferInfo',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'ISpEventSource',
    'SpeechRecoEvents', 'DISPID_SRCESoundStart',
    'DISPID_SRCERecognition', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SOTGetDescription', 'SP_VISEME_18',
    'DISPID_SDKGetStringValue', 'SPEI_RESERVED3',
    'DISPID_SLGetPronunciations', 'SP_VISEME_7', 'SRESoundEnd',
    'SAFTNonStandardFormat', 'DISPID_SOTDataKey',
    'SpeechDictationTopicSpelling', 'DISPID_SVGetProfiles',
    'DISPID_SPIGetText', 'DISPID_SBSWrite', 'DISPID_SDKGetlongValue',
    'SINoise', 'SAFT12kHz8BitMono', 'SP_VISEME_8',
    'SPAUDIOBUFFERINFO', 'SPEI_RESERVED1', 'ISpeechPhraseInfo',
    'SAFTCCITT_uLaw_11kHzStereo', 'SpAudioFormat',
    'ISpeechLexiconWord', 'SPEI_ADAPTATION', 'SpMMAudioOut',
    'DISPID_SpeechAudio', 'SpeechTokenValueCLSID', 'SVSFNLPMask',
    'DISPID_SRCBookmark', 'eLEXTYPE_PRIVATE18', 'SPSHORTCUTPAIRLIST',
    'SPGS_DISABLED', 'SAFTCCITT_ALaw_22kHzStereo',
    'SpeechAudioFormatType', 'SAFTADPCM_22kHzStereo', 'SPAR_Low',
    'ISpRecognizer3', 'DISPID_SRStatus', 'SAFT22kHz8BitMono',
    'SPEI_TTS_PRIVATE', 'SVSFNLPSpeakPunc', 'DISPID_SMSAMMHandle',
    'DISPID_SVSLastBookmark', 'ISpRecoGrammar2', 'SPINTERFERENCE',
    'DISPID_SRCCmdMaxAlternates', 'SGSExclusive', 'DISPID_SAStatus',
    'SpCompressedLexicon', 'DISPID_SRCRetainedAudio',
    'DISPID_SpeechObjectToken', 'SPVPRI_ALERT',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SGRId',
    'SpeechCategoryVoices', 'SITooQuiet',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SVGetVoices',
    'SPPS_Verb', 'ISpeechAudioBufferInfo', 'SPEI_END_INPUT_STREAM',
    'SpeechGrammarTagWildcard', 'SVSFParseSapi',
    'DISPID_SWFEBlockAlign', 'SpNotifyTranslator', 'SPXRO_SML',
    'SLTApp', 'SPRECOSTATE', 'SASRun', 'SLTUser',
    'DISPID_SpeechMMSysAudio', 'DISPID_SVSyncronousSpeakTimeout',
    'SPCT_DICTATION', 'SPEI_HYPOTHESIS', 'SSSPTRelativeToStart',
    'SPRST_INACTIVE', 'DISPID_SGRSTText', 'ISpeechResourceLoader',
    'DISPID_SpeechPhraseBuilder', 'ISpeechGrammarRules',
    'DISPID_SRGReset', 'DISPID_SPRuleName', 'SRAExport',
    'DISPID_SPPsItem', 'Speech_Default_Weight',
    'DISPID_SABIMinNotification', 'DISPID_SVSInputWordPosition',
    'DISPID_SRGetPropertyNumber', 'DISPID_SRCEPropertyStringChange',
    'eLEXTYPE_USER_SHORTCUT', 'SP_VISEME_11', 'SITooFast',
    'SpeechPropertyAdaptationOn', 'DISPID_SPAStartElementInResult',
    'SPSNoun', 'ISpStreamFormatConverter',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SRCEFalseRecognition', 'SPWORDPRONUNCIATIONLIST',
    'eLEXTYPE_PRIVATE17', 'SpeechWordPronounceable', 'SVSFlagsAsync',
    'SITooLoud', 'SPRST_ACTIVE_ALWAYS', 'DISPID_SWFEBitsPerSample',
    'SPWT_DISPLAY', 'DISPID_SPELexicalForm', 'DISPID_SRRAlternates',
    'DISPID_SVEEnginePrivate', 'DISPID_SpeechBaseStream',
    'SPWORDPRONUNCIATION', 'DISPID_SPRDisplayAttributes', 'SVP_4',
    'SAFT16kHz16BitStereo', 'SPPHRASEREPLACEMENT', 'SVPAlert',
    'SGRSTTWildcard', 'SAFT32kHz8BitStereo', 'SPAO_NONE',
    'SpSharedRecoContext', 'DISPID_SRSetPropertyString',
    'ISpStreamFormat', 'DISPID_SPRuleId', 'SPSHT_EMAIL',
    'DISPID_SRCRecognizer', 'DISPID_SGRClear',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SPPS_RESERVED2',
    'STSF_FlagCreate', 'SP_VISEME_5', 'DISPID_SGRsAdd',
    'DISPID_SVVoice', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SpMemoryStream', 'DISPID_SpeechPhraseProperties',
    'DISPID_SRRTTickCount', 'SAFTADPCM_8kHzMono', 'eLEXTYPE_PRIVATE2',
    'SVPNormal', 'SpeechGrammarTagDictation', 'SECFIgnoreKanaType',
    'DISPID_SRSAudioStatus', 'SPPS_NotOverriden', 'STCRemoteServer',
    'SAFTADPCM_44kHzStereo', 'tagSTATSTG', 'SPWF_SRENGINE',
    'DISPID_SpeechPhraseElements', 'SREStreamStart',
    'SAFT24kHz16BitStereo', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SPEDisplayText', 'DISPID_SRGSetTextSelection',
    'SPEI_PHONEME', 'eLEXTYPE_PRIVATE1', 'ISpeechObjectTokens',
    'SPCS_DISABLED', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SVSRunningState', 'SPEI_SOUND_END',
    'SPEI_SR_RETAINEDAUDIO', 'SPSNotOverriden',
    'DISPID_SRAudioInputStream', 'SAFT11kHz16BitStereo',
    'eLEXTYPE_MORPHOLOGY', 'SVEPhoneme',
    'DISPID_SpeechPhraseProperty', 'SPAUDIOSTATE',
    'SpeechPartOfSpeech', 'Speech_StreamPos_Asap',
    'SpeechTokenContext', 'STCInprocServer',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SREHypothesis',
    'DISPID_SRIsShared', 'SVSFParseAutodetect',
    'DISPID_SAFGetWaveFormatEx', 'ISpDataKey', 'DISPID_SPPConfidence',
    'ISpeechPhraseInfoBuilder', 'SPBOOKMARKOPTIONS',
    'SPEI_WORD_BOUNDARY', 'IInternetSecurityMgrSite',
    'DISPID_SDKSetStringValue', 'ISpNotifyTranslator',
    'DISPID_SPRsItem', 'eLEXTYPE_PRIVATE5',
    'DISPID_SVESentenceBoundary', 'SpeechDiscardType',
    'ISpeechPhraseElement', 'SVEAudioLevel', 'SDKLCurrentConfig',
    'SITooSlow', 'ISpRecoContext', 'DISPID_SRGCmdLoadFromMemory',
    'SRTExtendableParse', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SPDKL_LocalMachine', 'DISPID_SGRSTWeight',
    'DISPIDSPTSI_SelectionOffset', 'SPVPRI_NORMAL',
    'DISPID_SPIStartTime', 'SPSMF_UPS', 'SSFMCreateForWrite',
    'IEnumSpObjectTokens', 'eLEXTYPE_LETTERTOSOUND',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SLAddPronunciation',
    'DISPID_SRRDiscardResultInfo', 'SPSSuppressWord',
    'eLEXTYPE_RESERVED9', 'ISpPhoneticAlphabetSelection',
    'SPINTERFERENCE_TOOSLOW', 'DISPIDSPTSI',
    'ISpeechRecoResultDispatch', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SOTCreateInstance', 'DISPID_SBSRead', 'SPSEMANTICFORMAT',
    'DISPID_SVEWord', 'SPEI_SR_PRIVATE', 'DISPID_SLWs_NewEnum',
    'SpeechRecognitionType', 'SVEVoiceChange',
    'SWPUnknownWordUnpronounceable', 'DISPID_SAEventHandle',
    'DISPID_SGRSTPropertyName', 'DISPID_SpeechLexiconProns',
    'DISPID_SVIsUISupported', 'SVP_10', 'DISPID_SLPs_NewEnum',
    'DISPID_SPIAudioSizeBytes', 'SPSEMANTICERRORINFO',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SPRST_NUM_STATES',
    'SpeechInterference', 'DISPID_SRCEAudioLevel',
    'DISPID_SpeechLexicon', 'SRERequestUI', 'ISpeechVoiceStatus',
    'SpMMAudioEnum', 'DISPID_SGRInitialState',
    'DISPID_SVAudioOutputStream', 'SINoSignal',
    'DISPID_SPIProperties', 'SVSFIsNotXML', 'SSTTWildcard',
    'SVEPrivate', 'SVEAllEvents', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SGRs_NewEnum', 'SRCS_Disabled', 'DISPID_SPPParent',
    'ISpeechCustomStream', '_SPAUDIOSTATE', 'SpPhraseInfoBuilder',
    'DISPID_SGRSTsItem', 'SPDKL_CurrentUser',
    'ISpeechLexiconPronunciation', 'DISPID_SLRemovePronunciation',
    'DISPID_SVSVisemeId', 'SAFT11kHz16BitMono',
    'SpTextSelectionInformation', 'ISpeechAudio', 'SDKLLocalMachine',
    'DISPID_SLWType', 'SVSFIsFilename', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SRRAudioFormat', 'IStream', 'eLEXTYPE_PRIVATE16',
    'SPLO_STATIC', 'SPEI_UNDEFINED', 'DISPID_SpeechVoice',
    'SpeechAudioState', 'SGRSTTDictation', 'DISPID_SOTId',
    'ISpPhraseAlt', 'eLEXTYPE_PRIVATE15', 'SpeechStreamFileMode',
    'SPEI_PROPERTY_STRING_CHANGE', 'ISpeechMemoryStream',
    'SAFTCCITT_uLaw_8kHzMono', 'SREInterference', 'SPAR_High',
    'SSFMOpenReadWrite', 'SpeechAudioVolume', 'ISpeechXMLRecoResult',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SPEsItem',
    'SPLO_DYNAMIC', 'DISPID_SGRSTPropertyValue', 'ISpObjectWithToken',
    'DISPID_SVVolume', 'SSTTTextBuffer', 'SWPKnownWordPronounceable',
    'SPPS_SuppressWord', 'DISPID_SpeechPhraseReplacements',
    'DISPID_SpeechGrammarRule', 'SPSHORTCUTPAIR', 'ISpRecoResult',
    'DISPID_SVSLastBookmarkId', 'SPSUnknown', 'SRCS_Enabled',
    'DISPID_SRGetRecognizers', 'SP_VISEME_2', 'SRSInactive',
    'DISPID_SPAPhraseInfo', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SPPEngineConfidence', 'SpeechStreamSeekPositionType',
    'SAFTCCITT_ALaw_11kHzMono', 'SPAS_PAUSE',
    'DISPID_SpeechPhraseAlternates', 'SVF_None',
    'SAFTGSM610_22kHzMono', 'DISPID_SpeechPhraseAlternate',
    'SpPhoneConverter', 'eLEXTYPE_RESERVED8', 'SWTDeleted',
    'SpeechTokenShellFolder', 'SPAUDIOOPTIONS',
    'SAFTCCITT_uLaw_44kHzStereo', 'SPPS_RESERVED4',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SGRSTsCount',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SPIRule', 'SVP_16',
    'SPEI_VISEME'
]
